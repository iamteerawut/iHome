...
public class ViewHomestay extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //Score :
        PreparedStatement total_score = connection.prepareStatement("select sum(score)/count(review_id) score from test_base.review where homestay_id =" + request.getParameter("id"));
